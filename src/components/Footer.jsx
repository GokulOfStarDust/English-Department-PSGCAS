...
export default function Footer(){
    ...
    return(
        <footer className="flex flex-col w-[99.8%] mx-auto rounded-tl-[2rem] rounded-tr-[2rem] text-sm text-background-brown">
            <div className="flex flex-row flex-wrap items-center justify-between bg-[#242424] w-full  mt-6 rounded-tl-[2rem] rounded-tr-[2rem] pt-8 lg:pt-0">
                        ...
                        <div className="flex flex-row flex-wrap items-center justify-center font-plex pl-5">
                            ...
                            <a href="https://www.instagram.com/englishdept.psgcas/?utm_source=ig_web_button_share_sheet" target="_blank">
                                <div className="flex flex-row items-center space-x-2 p-2 border border-white rounded-xl">
                                    <img src="/instagram-icon.svg" alt="" className="size-4 object-contain"/>
                    ...
                    <div className="flex flex-col items-start justify-center font-plex space-y-5 pl-6 pr-2 pt-14 pb-7 lg:py-10 between-lg-xl:mr-24">                             
            ...
            <div className="flex flex-row items-center justify-center text-background-brown bg-[#232323] h-[55px] divide-x-2 space-x-3  border-t-2">
                ...
                <div className="flex flex-row space-x-3 pl-3">
                   <a href="https://www.instagram.com/theonefromthestardust/profilecard/?igsh=MW5odXdkNHlyMTh4cw==" target="_blank"> <img src="/instagram-icon-black.png" alt="" className="size-5 object-contain invert" /> </a>
                   <a href="https://www.linkedin.com/in/gokul-g-046b51292/" target="_blank"> <img src="/linkedin-icon-black.png" alt="" className="size-5 object-contain invert"/> </a>
                   <a href="https://github.com/GokulOfStarDust" target="_blank"> <img src="/github-icon-black.png" alt="" className="size-5 object-contain invert"/> </a>
                </div>
