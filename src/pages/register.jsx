    ...
    >
      ...
      >
        ...
        >
          ...
          <p className="pt-8 mb-7 font-plex font-normal text-center text-base lg:text-lg xl:text-xl">In keeping with tradition (and the charm of live encounters),the online payment is unavailable.<br/><br/>  Your registration fee of amount : ₹{totalRegistrationFee} is to be paid on the event day only. </p>
