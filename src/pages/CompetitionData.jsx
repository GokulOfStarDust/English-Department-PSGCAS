  ...
  asYouLikeLit: [
    {
      ...
      rules: {
        "General Rules": ["Rules will be anounced soon."],
      },
    },
...

    {
      ...
      description:
        "Navigate through a maze of puzzles and challenges that test your wit and reasoning. Connect the dots and find your way through intricate problems. Can you solve the puzzle and emerge victorious?",
      ...
      RegisterationFee: 0,
      registerationFeeInfo: "(Pay ₹30 and attend all the competitions)",
      guidelines: ["OD will be provided for PSGCAS students."],
      rules: {
        "General Rules": ["Rules will be anounced soon."],
      },
    },
