            ...
            <li key={index} className="list-none">
              <div>
                ...
                >
                  ...
                  >
                    <img
                      className={`w-[85svw] h-[45svh] md:h-[55svh] object-cover ${event.name === "Quiz" ? `object-top` : ""}  bg-top rounded-xl`}
                      src={event.imageUrl}
                  ...
                  <div
                    className="flex flex-row justify-center mx-auto bg-[url('/eventSubmitBg.png')] bg-cover w-[20%] min-w-[250px] !mt-9 md:!mt-[4.5%] text-md md:text-xl font-plex font-bold tracking-widest rounded-full p-4 cursor-pointer"
                    onClick={() => {
