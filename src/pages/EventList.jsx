      ...
      {eventData.upcomingEvents.map((event) => {
        return (
          <li key={event.id} className="list-none">
            <div>
              <motion.div className="flex flex-col bg-event-card-black w-[88svw] lg:h-[90svh] p-7 pt-7 space-y-5 rounded-3xl ">
                ...
                <motion.div className="font-plex font-light text-white text-sm md:text-md lg:text-lg -mt-4">
